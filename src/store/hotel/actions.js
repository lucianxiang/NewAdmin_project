...
export default {
  ...
  AddHotelImageType(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/ImageType/Insert',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  UpdateHotelImageType(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/ImageType/Update',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  DeleteHotelImageType(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/ImageType/Delete',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  AddHotelRecommendType(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/IntroduceType/Insert',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  UpdateHotelRecommendType(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/IntroduceType/Update',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  DeleteHotelRecommendType(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/IntroduceType/Delete',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  AddHotelThemeCategory(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/HotelThemeType/Insert',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  UpdateHotelThemeCategory(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/HotelThemeType/Update',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  DeleteHotelThemeCategory(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/HotelThemeType/Delete',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  initHotelCityRecommendType({commit},data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/AreaIntroduce/Select',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  AddHotelFacilitiesType(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/HardType/Insert',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  UpdateHotelFacilitiesTypee(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/HardType/Update',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  DeleteHotelFacilitiesType(store,data){
    return new Promise((relove, reject) => {
      request.post(getNewStr+'/HardType/Delete',JSON.stringify(data),{
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      }).then(data=>{
  ...
  AddHotelCityRecommendType(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/AreaIntroduce/Insert', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  UpdateHotelCityRecommendType(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/AreaIntroduce/Update', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  DeleteHotelCityRecommendType(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/AreaIntroduce/Delete', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  AddHotelFacilities(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/Hard/Insert', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  UpdateHotelFacilities(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/Hard/Update', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  DeleteHotelFacilities(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/Hard/Delete', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  AddHotelRoomFacilitiesType(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/RoomHardType/Insert', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  UpdateHotelRoomFacilitiesType(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/RoomHardType/Update', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  DeleteHotelRoomFacilitiesType(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/RoomHardType/Delete', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  AddHotelIconGallery(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/Image/Insert', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  UpdateHotelIconGallery(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/Image/Update', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  DeleteHotelIconGallery(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/Image/Delete', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  AddHotelRoomFacilities(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/RoomHard/Insert', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  UpdateHotelRoomFacilities(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/RoomHard/Update', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
  ...
  DeleteHotelRoomFacilities(store,data){
    return new Promise(function (relove, reject) {
      request.post(getNewStr+'/RoomHard/Delete', JSON.stringify(data), {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      })
